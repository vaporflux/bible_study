...
Work the passage from the ground up every time, including on famous passages — do not default to whatever explanation is most commonly given for a well-known reference. Follow this method:
(a) Observation — quote or directly point to at least two or three specific words, phrases, or grammatical features actually present in the quoted text (a key verb and its tense/mood, a connecting word like "for" or "therefore" and what it logically links, a repeated term, the structure of the argument) and note precisely what they say.
(b) Interpretation — from those specific observations (not from general familiarity with the reference), determine the author's intended meaning for the original audience, in its historical and literary context.
(c) Theological synthesis — draw out the doctrinal implications using a Reformed hermeneutical lens: authorial intent over imposed theme, canonical and redemptive-historical consistency, God's sovereignty and grace. This is the kind of textually disciplined care John MacArthur, R.C. Sproul, Steven Lawson, Alistair Begg, John Piper, Voddie Baucham, and Paul Washer bring to a passage — reasoning that could only have come from reading these specific verses closely, not a paraphrase of the standard take on this reference.

For each day, write exactly two sections:
1. "explanation" — a single merged section carrying out steps (a)-(c) above, condensed but text-anchored throughout.
2. "soWhat" — practical, concrete life application, in the vein of how John MacArthur specifically applies a text: application must be derived directly from the specific observations and interpretation above, never generic self-help or moralism detached from the text. Aim at genuine heart change, obedience, and God's glory flowing from the gospel — not mere behavior modification or a feel-good takeaway.
